...
<html>
<head>
<title>Sports Club Membership Registration form a Flat Responsive Widget Template :: w3layouts</title>
<!-- metatags-->
...
<h3>Your details</h3>
    ...
    <li>
        ...
        <div class="adderss">
            ...
            <span class="text">
                <input type="text" name="address" placeholder="street line2" required=" ">
            </span>
            <span class="text">
    ...
    <li>
                        ...
                        <ul class="radio-w3ls">
                            <li>
                                ...
                                <label for="a-option">Play For Football</label>
                                <div class="check"></div>
                            </li>
                            <li>
                                <input type="radio" id="b-option" name="selector1">
                                <label for="b-option">Play For Hockey</label>
                                <div class="check">
                            ...
                            <li>
                                <input type="radio" id="a-option" name="selector1">
                                <label for="a-option">Play For Tennis</label>
                                <div class="check"></div>
                            </li>
                            <li>
                                <input type="radio" id="b-option" name="selector1">
                                <label for="b-option">Play For Shuttle</label>
                                <div class="check">
                                    <div class="inside"></div>
                                </div>
                            </li>
...
<footer>&copy; 2018 Sports Club Membership. All Rights Reserved | Design by <a href="http://w3layouts.com/"> W3layouts</a></footer>
</body>
</html>